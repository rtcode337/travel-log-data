...
| [restaurant](restaurant/README.md)<br>(有名飲食店) | Wikipedia(ja)に記事がある店に絞った飲食店(網羅ではない) | 228 | 説明文: Wikipedia(ja)の記事<br>座標: OpenStreetMap(1件のみWikipedia) | 説明文: CC BY-SA 4.0<br>座標: ODbL |
