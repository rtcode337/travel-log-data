...
| [anime_seichi](anime_seichi/README.md)<br>(アニメ聖地) | アニメの聖地。アニメツーリズム協会の現行の選定地と、Wikipedia(ja)の舞台カテゴリ由来の2系統 | 165 | 説明文: Wikipedia(ja)の記事(全行の根拠を`evidence.csv`に保持)<br>座標: OpenStreetMap | 説明文: CC BY-SA 4.0<br>座標: ODbL |
