...
| [gotouchi_gourmet](gotouchi_gourmet/README.md)<br>(ご当地グルメ) | ご当地グルメ・郷土料理を、**その料理を食べに行く土地**に置いたもの | 1,961 | 説明文: Wikipedia(ja)の記事(全行の根拠を`evidence.csv`に保持)<br>座標: OpenStreetMap | 説明文: CC BY-SA 4.0<br>座標: ODbL |
