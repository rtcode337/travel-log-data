...
観光地(tourist)では**種類の分かる5つ**(神社仏閣・城・温泉・美術館博物館・商業施設)に
それぞれの形を割り当て、**「じっくり」はその後ろ**に置いている —— 種類が分かるほうを
...
5つのうち城だけが組み込みの`castle`で、他の4つは`path`で書いた形(五重塔・湯船と湯気・
神殿・ひさしのある店)。**中心に文字が乗るので、どれも中心を塗りで覆っている**。**形を増やすときは`lib/categoryStyle.ts`の`PIN_SHAPES`・
